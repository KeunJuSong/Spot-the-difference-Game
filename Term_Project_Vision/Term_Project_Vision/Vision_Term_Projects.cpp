...
#define RESOURSE_COUNT 11
#define GAMETIME 60 * 10
#define LIFE 3
...
void onMouse(int event, int x, int y, int flags, void* param)
{
	...
	temp = imread("level.jpg", IMREAD_COLOR);
	Mat level;
	...
	if (event == EVENT_LBUTTONUP) {
		...
		else if (mode == LEVEL)
		{
			...
			case 6:
				...
				break;
			case 7:
				temp = imread("resource7.jpg", IMREAD_COLOR);
				temp2 = imread("copy7.jpg", IMREAD_COLOR);
				break;
			case 8:
				temp = imread("resource8.jpg", IMREAD_COLOR);
				temp2 = imread("copy8.jpg", IMREAD_COLOR);
				break;
			case 9:
				temp = imread("resource9.jpg", IMREAD_COLOR);
				temp2 = imread("copy9.jpg", IMREAD_COLOR);
				break;
			case 10:
				temp = imread("resource10.jpg", IMREAD_COLOR);
				temp2 = imread("copy10.jpg", IMREAD_COLOR);
				break;
			default:
				temp = imread("resource0.jpg", IMREAD_COLOR);
				temp2 = imread("copy0.jpg", IMREAD_COLOR);
